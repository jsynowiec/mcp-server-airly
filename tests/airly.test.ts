...
describe("AirlyClient", () => {
  ...
  describe("error handling", () => {
    ...
    it("throws AirlyApiError on 404", async () => {
      ...
      await expect(client.getInstallation(99999)).rejects.toThrow(
        AirlyApiError,
      );
    });
    ...
    it("throws AirlyApiError on 500", async () => {
      ...
      await expect(client.getMeasurementPoint(50.062, 19.941)).rejects.toThrow(
        AirlyApiError,
      );
    });
    ...
    it("propagates network errors from fetch", async () => {
      ...
      await expect(
        client.getInstallation(204, { skipCache: true }),
